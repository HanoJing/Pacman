...
public class Player_Girly {
    ...
    public Player_Girly(int startX, int startY, int width, int heigth, int startAngle, int arcAngle, Color color) {
    ...
    public void drawPlayer_Girly(Graphics g){
    ...
    public void showPlayer_Girly(Graphics g) {
        g.setColor(color);
