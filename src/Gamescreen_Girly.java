...
public class Gamescreen_Girly extends JPanel {
    ...
    public void checkKollision() {
        ...
        if(map.h1.x<=pacMan.startX && (map.h1.x+map.h1.width)>pacMan.startX && map.h1.y<=pacMan.startY && (map.h1.y+map.h1.height)>=pacMan.startY+pacMan.heigth) {
            ...
            kollision = true;
        }else if(map.h34.x<=pacMan.startX && (map.h34.x+map.h34.width)>pacMan.startX && map.h34.y<=pacMan.startY && (map.h34.y+map.h34.height)>=pacMan.startY+pacMan.heigth) {
        	kollision = true;
        }else if(map.h35.x<=pacMan.startX && (map.h35.x+map.h35.width)>pacMan.startX && map.h35.y<=pacMan.startY && (map.h35.y+map.h35.height)>=pacMan.startY+pacMan.heigth) {
        	kollision = true;
        }else if(map.h36.x<=pacMan.startX && (map.h36.x+map.h36.width)>pacMan.startX && map.h36.y<=pacMan.startY && (map.h36.y+map.h36.height)>=pacMan.startY+pacMan.heigth) {
        	kollision = true;
        }else if(map.h37.x<=pacMan.startX && (map.h37.x+map.h37.width)>pacMan.startX && map.h37.y<=pacMan.startY && (map.h37.y+map.h37.height)>=pacMan.startY+pacMan.heigth) {
        	kollision = true;
        }else {
        	kollision = false;
        }
