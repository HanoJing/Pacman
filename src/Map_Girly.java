...
public class Map_Girly {
    ...
    public static Rectangle_Girly[] rect = new Rectangle_Girly[44];
    ...
    public Map_Girly() {
        ...
        rect[18] = new Rectangle_Girly(200,200,55,255);       //G
        rect[19] = new Rectangle_Girly(400,200,55,255);       //I
        rect[20] = new Rectangle_Girly(500, 200, 155, 155);   //R
        rect[21] = new Rectangle_Girly(500, 200, 55, 255);
        rect[22] = new Rectangle_Girly(550, 250, 55, 55);
        rect[23] = new Rectangle_Girly(615, 415, 40, 40);
        rect[24] = new Rectangle_Girly(700,200,55,255);       //L
        rect[25] = new Rectangle_Girly(700,400,155,55);
        rect[26] = new Rectangle_Girly(850,200,55,155);       //Y
        rect[27] = new Rectangle_Girly(950,200,55,155);
        rect[28] = new Rectangle_Girly(850,300,155,55);
        rect[29] = new Rectangle_Girly(500, 6, 55, 149);      //...
        ...
        rect[37] = new Rectangle_Girly(150, 50, 255, 55);
        rect[38] = new Rectangle_Girly(850,50,255,55);
        rect[39] = new Rectangle_Girly(150, 550, 255, 55);
        rect[40] = new Rectangle_Girly(850,550,255,55);
        rect[41] = new Rectangle_Girly(700,6,49,148);
        rect[42] = new Rectangle_Girly(900,300,55,155);
        rect[43] = new Rectangle_Girly(1000,400,55,55);
    }
