...
public class Map_Girly {
    ...
    public Map_Girly() {
        ...
        rect[22] = new Rectangle_Girly(400,200,55,255);       //I
        rect[23] = new Rectangle_Girly(500, 200, 155, 155);   //R
        ...
        rect[27] = new Rectangle_Girly(700,200,55,255);       //L
        rect[28] = new Rectangle_Girly(700,400,155,55);
        rect[29] = new Rectangle_Girly(850,300,155,55);       //Y
