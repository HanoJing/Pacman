...
public class Spielfigur_Girly {
    ...
    public Spielfigur_Girly(int startX, int startY, int heigth, int width, int startAngle, int arcAngle, Color farbe) {
    ...
    public void moveSpielfigur_Girly() {
        ...
        if(KeyDispatcher_Girly.upPressed == true && startY >= 30) {
            this.startAngle = 480;
            this.startY -= 50;
            moveFigur2 = true;
        }else if(KeyDispatcher_Girly.downPressed == true && startY <= 580) {
            this.startAngle = 300;
            this.startY += 50;
            moveFigur2 = true;
        }else if(KeyDispatcher_Girly.leftPressed == true && startX >= 30) {
            this.startAngle = 210;
            this.startX -= 50;
            moveFigur2 = true;
        }else if(KeyDispatcher_Girly.rightPressed == true && startX <= 1200) {
            this.startAngle = 380;
            this.startX += 50;
            moveFigur2 = true;
        }
